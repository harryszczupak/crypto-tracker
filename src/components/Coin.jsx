...
const Coin = ({ coin }) => {
	return (
		<li className='flex items-center space-x-4 p-3 bg-gray-900 rounded-lg shadow hover:shadow-yellow-500/50 transition border-gray-700 border cursor-pointer mb-5'>
			<img
				src={coin.image}
				alt={coin.name}
